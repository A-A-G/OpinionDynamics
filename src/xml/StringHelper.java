...
/**
 * Utilities for String formatting, manipulation, and queries. More information about this class is available from <a target="_top" href= "http://ostermiller.org/utils/StringHelper.html">ostermiller.org</a>.
 * 
	...
	public static String unescapeHTML(String s)
	{
		...
		while (ampInd >= 0)
		{
			...
			if (nextSemi != -1 && (nextAmp == -1 || nextSemi < nextAmp))
			{
				...
				{
					System.out.println("StringHelper: " + x.toString());
				}
